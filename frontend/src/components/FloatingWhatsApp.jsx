...
export default function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      ...
      <div
        className="w-12 h-12 rounded-full bg-[#25D366] flex items-center justify-center shadow-[0_4px_30px_rgba(37,211,102,0.65)] hover:shadow-[0_6px_40px_rgba(37,211,102,0.85)] hover:scale-110 transition-all duration-300 lg:h-14 lg:w-14"
      >
